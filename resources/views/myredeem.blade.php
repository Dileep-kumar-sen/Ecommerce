...
@section('title', 'My Redeem')

@section('content')
<div class="container mx-auto p-14">
    <h2 class="text-xl font-bold mb-6 text-gray-800 text-center">My Redeemed Coupons</h2>
...
$(function () {
    $('#redeemTable').DataTable({
        ...
        language: {
            ...
            zeroRecords: "No redeemed coupons found",
